...
const BackInStockNotificationEmail = ({ productTitle, variantTitle, productHandle, productImage }: BackInStockNotificationProps) => {
  const productUrl = productHandle ? `${SITE_URL}/products/${productHandle}` : SITE_URL

  return (
    <Html lang="en" dir="ltr">
      <Head />
      <Preview>{productTitle || 'An item you wanted'} is back in stock!</Preview>
      <Body style={main}>
          ...
          <Container style={heroContainer}>
            <Row>
              ...
              <Column style={heroTextCol}>
                <Heading style={heroHeading}>IT'S BACK 🔥</Heading>
                <Text style={heroSubhead}>
                  The item you've been waiting for just restocked.
                </Text>
              </Column>
            </Row>
          </Container>
        ...
        <Container style={container}>
          <Section style={card}>
            ...
            <Text style={bodyText}>
              These tend to move fast — grab yours before it sells out again.
            </Text>
          </Section>

          <Section style={ctaSection}>
            <Button style={ctaButton} href={productUrl}>
              SHOP NOW
            </Button>
          </Section>
          ...
          <Text style={noteText}>
            You received this because you signed up for a back-in-stock alert.
          </Text>
...
export const template = {
  component: BackInStockNotificationEmail,
  subject: (data: Record<string, any>) =>
    `${data.productTitle || 'Your item'} is back in stock!`,
  displayName: 'Back in stock notification',
  previewData: {
    productTitle: 'Daggers Tee',
    variantTitle: 'Large / Black',
    productHandle: 'daggers-tee',
    productImage: 'https://smmeufktnfgefknaisrr.supabase.co/storage/v1/object/public/email-assets/sullen-badge-logo.png',
  },
...
const itemName = { fontSize: '16px', fontWeight: '600' as const, color: '#1a1a1a', margin: '0 0 8px', lineHeight: '1.3' }
...
const noteText = { fontSize: '11px', color: '#999999', margin: '0 0 16px', textAlign: 'center' as const }
