...
export const InviteEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to join the Sullen Family</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          You've been invited to join the Sullen Art Collective. Accept the invitation
          below to create your account and start earning Skull Points.
        </Text>
